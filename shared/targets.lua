...
if TargetType == 'qb' then
    ...
    exports['qb-target']:AddBoxZone("BossMenuZone", Config.InteractionLocations.Job.BossMenu.Location, Config.InteractionLocations.Job.BossMenu.Width, Config.InteractionLocations.Job.BossMenu.Height, {
        name = "BossMenuZone",
    ...
    exports['qb-target']:AddBoxZone("PaymentZone", Config.InteractionLocations.Payment.Location, Config.InteractionLocations.Payment.Width, Config.InteractionLocations.Payment.Height, {
        name = "PaymentZone",
    ...
    exports['qb-target']:AddBoxZone("CollectionTrayZone", Config.InteractionLocations.CollectionTray.Location, Config.InteractionLocations.CollectionTray.Width, Config.InteractionLocations.CollectionTray.Height, {
    ...
    exports['qb-target']:AddBoxZone("SmoothieMachineZone", Config.InteractionLocations.SmoothieMachine.Location, Config.InteractionLocations.SmoothieMachine.Width, Config.InteractionLocations.SmoothieMachine.Height, {
    ...
    exports['qb-target']:AddBoxZone("HotDrinksMachineZone", Config.InteractionLocations.HotDrinksMachine.Location, Config.InteractionLocations.HotDrinksMachine.Width, Config.InteractionLocations.HotDrinksMachine.Height, {
    ...
    exports['qb-target']:AddBoxZone("StorageFridgeZone", Config.InteractionLocations.Storage.Fridge.Location, Config.InteractionLocations.Storage.Fridge.Width, Config.InteractionLocations.Storage.Fridge.Height, {
    ...
    exports['qb-target']:AddBoxZone("IngredientsTrayZone", Config.InteractionLocations.Ingredients.Location, Config.InteractionLocations.Ingredients.Width, Config.InteractionLocations.Ingredients.Height, {
    ...
    exports['qb-target']:AddBoxZone("SnackShelfZone", Config.InteractionLocations.SnackShelf.Location, Config.InteractionLocations.SnackShelf.Width, Config.InteractionLocations.SnackShelf.Height, {
        name = "SnackShelfZone",
